...
namespace TuskKer
{
    public partial class UnassignedTasks : System.Web.UI.Page
    {
            ...
            if (recv_mess != "")
            {
                ...
                for (int i = 0; i < nr_task.Length; i++)
                {
                    ...
                    for (int cellNum = 0; cellNum < words.Length; cellNum++)
                    {
                        ...
                        {
                            int sec = Int32.Parse(words[5]); //secunde
                            if (sec < 1800 && sec > 600)
                            {
                                cel.BackColor = Color.Orange;
                                cel.ForeColor = Color.White;
                            ...
                            labels[i * 3 + cellNum - 5] = new Label();
                            if (k)
                            {
                                labels[i * 3 + cellNum - 5].Text = ore.ToString() + ":" + str_min + ":" + str_sec;
                            ...
                            cel.Controls.Add(labels[i * 3 + cellNum - 5]);
                        }
                        rw.Cells.Add(cel);
                        counter++;
                    }
