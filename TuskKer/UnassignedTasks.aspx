<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnassignedTasks.aspx.cs" Inherits="TuskKer.UnassignedTasks" %>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="UnassignedTasks.aspx"><i class="fa fa-tasks"></i><span>All Tasks<br></span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; All Tasks:<table class="w-100">
                            <tr>
                                <td>
                                    <br />
                                    <asp:Table ID="Table1" runat="server" Width="1250px" BorderColor="#999999" BorderStyle="Solid" GridLines="Horizontal" Height="40px">
                                        <asp:TableHeaderRow 
                                           ...
                                           >
                                            <asp:TableHeaderCell Width="200">Username</asp:TableHeaderCell>
