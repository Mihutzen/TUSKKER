<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyTeam.aspx.cs" Inherits="TuskKer.MyTeam" %>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                            <table class="w-100">
                            <tr>
                                <td>
                                    <br />
                    ...
                    <br/>
                        ...
                        <br/>
                        <asp:Label ID="Label4" runat="server" Text="Mail adress: "></asp:Label>
